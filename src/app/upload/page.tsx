...
export default function UploadPage() {
  ...
  const handleSubmit = async () => {
    if (isExtracting) { toast.error('Please wait, CV is still being processed.'); return; }
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="card p-6 space-y-4">
          ...
          {isExtracting && (
            <p className="text-xs text-brand-600 flex items-center gap-2">
              <Loader2 size={12} className="animate-spin" /> Extracting CV text from file...
            </p>
          )}
        ...
        >
          {loading
            ...
            : isExtracting
            ? <><Loader2 size={16} className="animate-spin" /> Processing CV file...</>
